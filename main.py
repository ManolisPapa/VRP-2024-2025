...
for seed in range(1, 6):
    ...
    localSolver = LocalSolver(m, seed)
    ...
    timeend = time.time()
    results[seed - 1].append((seed, 'Draft Routing', solver.sol.cost, (timeend - timestart)/60))
    print(1)
    ...
    results[seed - 1].append((seed, 'Emm&Emm', solver.sol.cost, (timeend - timestart)/60))
    print(1)
    ...
    timeend = time.time()
    print((timeend - timestart)/60)
    results[seed - 1].append((seed, 'Clarke&Wright', solver.sol.cost, (timeend - timestart)/60))
    print(1)
    ...
    timeend = time.time()
    print((timeend - timestart)/60)
    results[seed - 1].append((seed, 'Tn Per Km', solver_tn_per_km.sol.cost, (timeend - timestart)/60))
    print(1)
